...
public class add_Servlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try 
		{
			...
			request.setAttribute("info",new String("<br><br><center><h1><font color=red>Success!Conrgatulation!!" +
					"</font></h1></center><br>"));
			request.setAttribute("info",new String("<br><br><center><h1><font color=red>Success!Conrgatulation!!" +nam+
					"</font></h1></center><br>"));
