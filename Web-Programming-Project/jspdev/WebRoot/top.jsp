...
-->
  ...
  %>
   ...
   <body onload="init()">
   <table width="801" height="91" border="0" align="center" cellpadding="0" cellspacing="0" >  <!--background="img/banner0.gif"-->
     <tr>
       <td width="608" rowspan="2" > <p class="style6"><br>
       </td>
       <td height="15" ></td>
      
     </tr>
     <tr>
       <td width="152" height="41" ><SCRIPT language=javascript>
<!--
calendar = new Date();
day = calendar.getDay();
...
document.write("<font color=FF0000>"+year +"/");
...
//-->
     ...
     <tr >
       <td width="608" ><span class="style6">Welcome <font color=red>${sessionScope.name}</font> Enter Student Management System</span></td>
       <td height="35"  ></td>
     </tr>
  </table>
