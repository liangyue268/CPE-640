   ...
   function J(f)
{
 ...
 <body background="img/background.jpg">
    ...
    <table width="970" height="318" border="0">
      <tr>
        <td height="200" colspan="222" background="img/top222.jpg"></td>
        <td width="50">&nbsp;</td>
        <td width="75">&nbsp;</td>
      </tr>
      <tr>
        ...
        <td colspan="2">
<FORM name="f" action="/jspDev/servlet/Login_Servlet" method="post" onsubmit="return J(f);">
   <P align="center"><br><br>
   Name: <INPUT type="text" name="name"><BR><BR>
   Password: <INPUT type="password" name="pwd"><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   </P><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <!--<input type="Image" name="submit"  src=img/login_top.jpg width="70" height="22"> -->
		  <input type="submit" name="submit"  value = "Login" > 
         <!-- <img src=img/reg_top.jpg width="70" height="22" border="0">-->
                    <!-- <a href="addUser.jsp">Register </a><br> 
          <a href="addUser.jsp" target="frm" class="style2">Register</a></td>-->
          <a href="addUser.jsp">
          <input type="button" name="submit1"  value = "Register"></a></td>
</FORM>
    </td>
        <td>&nbsp;</td>
      </tr>
